...
def load_model_and_data():
    model = XGBRegressor()
    model.load_model("C:/Users/zarar/Desktop/ZDoc/Graduate Center/Big Data/Project/NYC-Taxi-A-Data-Science-Project/models/xgboost_model.json")  # Replace with your model path
...
# Title
st.title("NYC Uber Rides Demand Prediction")
...
# Display the map
st.write(f"Heatmap of Predicted Uber Rides Demand <br> Date: {selected_date.strftime('%B %d, %Y')} ({day_name_map[day_of_week]})", unsafe_allow_html=True)
