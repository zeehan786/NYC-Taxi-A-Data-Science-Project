...
def load_model_and_data():
    model = XGBRegressor()
    model.load_model("C:/Users/zarar/Desktop/ZDoc/Graduate Center/Big Data/Project/NYC-Taxi-A-Data-Science-Project/models/xgboost_model_lyft.json")  # Replace with your model path
